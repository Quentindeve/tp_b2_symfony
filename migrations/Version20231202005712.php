 ...
 */
final class Version20231202005712 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT NOT NULL, post_id INT NOT NULL, publisher_id INT NOT NULL, content TEXT NOT NULL, PRIMARY KEY(id))');
